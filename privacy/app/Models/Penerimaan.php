...
class Penerimaan extends Model
{
    ...
    public static function getjurnal()
    {
        ...
        $jurnal1 = '130'.'.'.$kode_company.$tahun.'.'.$bulan.'.';
    ...
    {
        $konek = static::konek();
        $kode = TransaksiSetup::where('kode_setup','003')->first();
        ...
        $lastRecort = self::on($konek)->where($primary_key,'like',$prefix_result.'%')->orderBy('no_penerimaan', 'desc')->first();

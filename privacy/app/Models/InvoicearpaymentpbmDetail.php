...
class InvoicearpaymentpbmDetail extends Model
{
    //
    use AuditableTrait;

    protected $table = 'invoicearpaymentpbm_detail';
    ...
    {
        return $this->belongsTo(Currency::class,'kode_currency');
    }  
    ...
    public static function getjurnal($kode_jurnal, $tgl_jalan2)
    {
        ...
        $cek_jurnal = InvoicearumpaymentDetail::on($konek)->where(DB::raw('LEFT(no_journal,12)'),$jurnal1)->orderBy('created_at','desc')->first();
        if ($cek_jurnal != null ) {
        ...
        $cek_jurnal8 = Invoicearsub::on($konek)->where(DB::raw('LEFT(no_journal,12)'),$jurnal1)->orderBy('created_at','desc')->first();
        if ($cek_jurnal8 != null ) {
        ...
        $cek_jurnal9 = Invoicearum::on($konek)->where(DB::raw('LEFT(no_journal,12)'),$jurnal1)->orderBy('created_at','desc')->first();
        if ($cek_jurnal9 != null ) {
        ...
        $lenger = max($leng, $leng2, $leng3, $leng4, $leng5, $leng6, $leng7, $leng8, $leng9, $leng10, $leng11, $leng12, $leng13);

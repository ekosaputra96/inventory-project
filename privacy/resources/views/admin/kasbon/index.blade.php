    ...
    <body onLoad="load()">
        <div class="box box-solid">
            <div class="box-body">
                <div class="box">
                    <div class="box-body">
                        <button type="button" class="btn btn-default btn-xs" onclick="refreshTable()"><i
        ...
        <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-map-marker"
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <button type="button" class="btn btn-warning btn-xs edit-button" id="editpkb" data-toggle="modal"
                data-target="">EDIT <i class="fa fa-edit"></i></button>

            <button type="button" class="btn btn-danger btn-xs hapus-button" id="hapuspkb" data-toggle="modal"
                data-target="">HAPUS <i class="fa fa-times-circle"></i></button>

            <button type="button" class="btn btn-info btn-xs tombol3" id="button3">APPROVE <i
                    class="fa fa-bullhorn"></i></button>

            <button type="button" class="btn btn-success btn-xs tombol1" id="button1">POST <i
                    class="fa fa-bullhorn"></i></button>

            <button type="button" class="btn btn-warning btn-xs tombol2" id="button2">UNPOST <i
                    class="fa fa-undo"></i></button>

            <a href="#" target="_blank" id="printkasbon"><button type="button"
                    class="btn btn-danger btn-xs print-button" id="button6">PRINT <i
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on('click', 'tr', function() {
                if ($(this).hasClass('selected bg-gray text-bold')) {
                    ...
                    var print = $("#printkasbon").attr("href",
                        "http://localhost/gui_inventory_laravel/admin/kasbon/exportpdf?no_pkb=" + no_pkb
                        );
                    if (status == 'POSTED') {
                        $('.tombol1').hide();
                        $('.tombol2').show();

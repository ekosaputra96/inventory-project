...
@section('title', 'Laporan QTY Pemakaian')
        ...
        <div class="modal fade" id="button4"  role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                {!! Form::open(['route' => ['laporanpemakaianqty.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]) !!}
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">  
                                        {{ Form::label('show', 'Produk / Kategori:') }}              
                                        {{Form::select('show', ['Produk' => 'Produk', 'Kategori' => 'Kategori'], null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'history','required'=>'required','onchange'=>"pilih();"])}}
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="form-group2">
                                        ...
                                        {{ Form::select('kategori',['SEMUA'=>'SEMUA',$kategori],null, ['class'=> 'form-control select2','id'=>'kategori1','style'=>'width: 100%','placeholder' => '']) }}
                                    </div>   
                                </div> 
    ...
    <script type="text/javascript">
        ...
        function cetakpdf() {
            ...
            if (e.value === true) {
                ...
                $.ajax({
                    url:'{!! route('laporanpemakaianqty.export') !!}',
                    type:'GET',
                    data:formData,

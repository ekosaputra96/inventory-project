        ...
        <div class="modal fade" id="button4"  role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                {!! Form::open(['route' => ['laporanpenerimaan.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group"> 
                                            ...
                                            {{Form::select('status', ['SEMUA' => 'SEMUA', 'OPEN' => 'OPEN', 'POSTED' => 'POSTED', 'RETUR' => 'RETUR'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'status1','required'=>'required'])}}
                                        </div>
                                    </div>
                                    <div class="col-sm-4">   
                                        <div class="form-group">     
    ...
    <script type="text/javascript">
        ...
        function cetakpdf() {
            ...
            if (e.value === true) {
                ...
                $.ajax({
                    url:'{!! route('laporanpenerimaan.export') !!}',
                    type:'GET',
                    data:formData,

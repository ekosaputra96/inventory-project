        ...
        <div class="modal fade" id="button4"  role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                {!! Form::open(['route' => ['laporanopname.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::select('lokasi',['Lokasi'=>$lokasi],null, ['class'=> 'form-control select2','id'=>'lokasi1','style'=>'width: 100%','placeholder' => '','required']) }}
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                            <br>
    ...
    <script type="text/javascript">
        ...
        function cetakpdf() {
            ...
            if (e.value === true) {
                ...
                $.ajax({
                    url:'{!! route('laporanopname.export') !!}',
                    type:'GET',
                    data:formData,

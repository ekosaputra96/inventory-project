...
@section('title', 'Laporan Pemakaian Ban')
        ...
        <div class="modal fade" id="button4"  role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                {!! Form::open(['route' => ['laporanpemakaianban.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group"> 
                                            ...
                                            {{Form::select('tipe', ['SEMUA' => 'SEMUA', 'Alat' => 'Alat', 'Mobil' => 'Mobil'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'tipe1','required'=>'required', 'onchange'=>"cektipe()"])}}
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">  
    ...
    <script type="text/javascript">
        ...
        function cetakpdf() {
            ...
            if (e.value === true) {
                ...
                $.ajax({
                    url:'{!! route('laporanpemakaianban.export') !!}',
                    type:'GET',
                    data:formData,

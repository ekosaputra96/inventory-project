                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('tanggals', 'Tanggal Retur Pemakaian:') }}
                                    {{ Form::date('tgl_retur_pemakaian', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal','required'=>'required'])}}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('Nomors', 'No Pemakaian:') }}
                                    {{ Form::select('no_pemakaian',$Pemakaian, null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Pemakaian','required']) }}
                                </div>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            {{ Form::label('Nomors', 'No Retur Pemakaian:') }}
                            {{ Form::text('no_retur_pemakaian', null, ['class'=> 'form-control','id'=>'Returbeli1','readonly']) }}
                        </div>
                    </div> 
                    <div class="col-md-4">
                        <div class="form-group">
                            {{ Form::label('Tanggals', 'Tanggal Retur Pemakaian:') }}
                            {{ Form::date('tgl_retur_pemakaian',null,['class'=> 'form-control','id'=>'Tanggal1','required'])}}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            {{ Form::label('Pakais', 'No Pemakaian:') }}
                            {{ Form::text('no_pemakaian',null, ['class'=> 'form-control','id'=>'Pemakaian1','placeholder'=>'','style'=>'width: 100%','readonly']) }}
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        function getkode(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        url:'{!! route('returpemakaian.getkode') !!}',
                        type:'POST',
        ...
        $(function() {
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('returpemakaian.data') !!}',
        ...
        function getpo(){
            ...
            $.ajax({
                url:'{!! route('returpemakaian.getpo') !!}',
                type:'POST',
                data : {
        ...
        function getpo1(){
            ...
            $.ajax({
                url:'{!! route('returpemakaian.getpo1') !!}',
                type:'POST',
                data : {
                        'no_penerimaan': no_penerimaan,
                    },
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    $.ajax({
                        url: '{!! route('returpemakaian.historia') !!}',
                        type: 'GET',
                        data : {
            ...
            $('#button1').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                        $.ajax({
                            url: '{!! route('returpemakaian.posting') !!}',
                            type: 'POST',
                            data : {
            ...
            $('#button2').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                $.ajax({
                    url: '{!! route('returpemakaian.unposting') !!}',
                    type: 'POST',
                    data : {
                        'id': no_returpemakaian,
                        'no_penerimaan': no_penerimaan
            ...
            $('#detailjurnal2').click( function () {
                ...
                $.ajax({
                    url: '{!! route('returpemakaian.getDatajurnal2') !!}',
                    type: 'GET',
                    data : {
                        'id': no_journal,
                    },
            ...
            function cekjurnal2(){
                ...
                $.ajax({
                    url:'{!! route('returpemakaian.cekjurnal2') !!}',
                    type:'POST',
                    data : {
            ...
            $('#button4').click( function () {
                ...
                $.ajax({
                    url: '{!! route('returpemakaian.showdetail') !!}',
                    type: 'POST',
                    data : {
                        'id': no_returpemakaian
                    },
            ...
            $('#editreturpembelian').click( function () {
                ...
                var row = table.row( select );
                $.ajax({
                    url: '{!! route('returpemakaian.edit_returpemakaian') !!}',
                    type: 'POST',
                    data : {
                        'id': no_returpemakaian
                    },
            ...
            $('#hapusreturpembelian').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '{!! route('returpemakaian.hapus_returpemakaian') !!}',
                            type: 'POST',
                            data : {
                                'id': no_returpemakaian
                            },
        ...
        $('#ADD').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'{!! route('returpemakaian.store') !!}',
                    type:'POST',
                    data:formData,
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'{!! route('returpemakaian.updateajax') !!}',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        $('#editform').modal('hide');

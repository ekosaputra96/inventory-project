...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    ?>
    <?php if ($aset != 'SEMUA') { ?>
        <title>MAINTENANCE RECORD {{ $aset }}</title>
    <?php } else { ?>
...
<div class="fixed-header">
        ...
        <br><br>
            <?php
                if ($kategori != 'SEMUA') {?>
                <?php if ($aset != 'SEMUA') { ?>
                    <h1>MAINTENANCE RECORD <?php echo $kategori; ?> NO ASET <?php echo $aset; ?></h1>
                <?php }else { ?>
            ...
            <?php } 
                ...
                <?php if ($aset != 'SEMUA'){ ?>
                    <h1>MAINTENANCE RECORD <?php echo $aset; ?></h1>
                <?php } else { ?>
...
?>
    <table class="grid1" style="margin-bottom: 25px;width: 100%; font-size: 11px">
        ...
        ?>
            ...
            <?php } ?>
                <td class="border" align="left"><?php echo $row->hmkm?></td>

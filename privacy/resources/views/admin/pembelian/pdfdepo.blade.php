        ...
        <table class="grid" style="font-size: 10pt; width: 21cm;" border="0" >
            ...
            <?php foreach ($pembeliandetail as $key => $value): ?>
                <tr >
                    ...
                    <td style="text-align: center;">{{ $value->kode_satuan }}</td>
        ...
        <table width="100%" style="font-size:10pt; text-align:center;padding:0px; margin:0px; border-collapse:collapse" border="0">
            ...
            <tr style="padding:0px; margin:0px">
                ...
                <?php if (file_exists($cekdibuat)) { ?>
                    <td><img src="{{ $cekdibuat }}" alt="" height="70px" width="70px" align="center"></td>
                <?php }else { ?>
                    <td><br><br><br></td>
                <?php } ?>
                
                <?php if (file_exists($cekdiperiksa)) { ?>
                    <td><img src="{{ $cekdiperiksa }}" alt="" height="70px" width="70px" align="center"></td>
                <?php }else { ?>
                    <td><br><br><br></td>
                <?php } ?>
                
                <?php if (file_exists($cekdisetujui)) { ?>
                    <td><img src="{{ $cekdisetujui }}" alt="" height="70px" width="70px" align="center"></td>
                <?php }else { ?>
                    <td><br><br><br></td>
                <?php } ?>
                
                <?php if (file_exists($cekdiketahui)) { ?>
                    <td><img src="{{ $cekdiketahui }}" alt="" height="70px" width="70px" align="center"></td>
                <?php }else { ?>
                    <td><br><br><br></td>
                <?php } ?>
            </tr>

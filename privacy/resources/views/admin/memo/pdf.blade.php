...
<div class="header">
    <div class="left">
        <table width="40%" style="  font-size: 10pt" border="0">
            <tr >
                <td style="width: 100px">No NPPB</td>
            ...
            <tr>
                <td >Lokasi</td>
                <td>:</td>
                <td style="font-size: 9pt">{{ $memo->kode_lokasi }}</td>
            </tr>
        </table>
    </div>
    <div class="right">
        <table width="51%" style="font-size: 10pt; padding-left: 220px" border="0">
            <tr >
                <td style="width: 100px">Tgl Memo</td>
                <td style="width: 10px">:</td>
                <td>{{ $memo->tgl_memo}}</td>
            </tr>
        ...
        <table class="grid" style="font-size: 10pt; width: 850px;" border="0" >
            <thead>
                ...
                <tr >
                    ...
                    <td style="text-align: right;">Qty TO</th>
            ...
            <tbody>
            <?php $key = 0; ?>
            <?php foreach ($memodetail as $key => $value): ?>
                <tr>
                    ...
                    <td style="text-align: right; padding-right: 12px;"><?php echo $value->qty_to ?></td>
                    <td style="text-align: right; padding-right: 12px;"><?php echo ($value->qty_to - $value->qty)?></td>
                </tr>
            <?php endforeach ?>
            </tbody>
        </table>
        <div class="catatan" style="float: left; padding-top:5px; padding-left: 20px">
            <p>*) Note: <?=$memo->keterangan?></p>
        </div>
    </section>
</div>

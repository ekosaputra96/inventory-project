        ...
        <div class="box-body">
            <div class="box">
                <div class="box-body">
                    ...
                    @permission('create-memo')
                    <button type="button" class="btn btn-danger btn-xs" id="new-button" data-toggle="modal" data-target="#addform"><i class="fa fa-plus"></i> New NPPB</button>
                    <i>&nbsp;ALT+1 = New NPPB (shortcut)</i>
                    @endpermission
                    ...
                    <?php } ?>
                        <font style="font-size: 16px;"><b>NPPB</b></font>
                    </span>
                </div>
            </div>
        ...
        $(document).ready(function() {
            ...
            $('#editpembelian').click( function () {
                ...
                $.ajax({
                    ...
                    success: function(results) {
                        $('#editform').modal('show');
                        $('#Memo').val(results.no_memo);
                        $('#Tanggal').val(results.tgl_memo);

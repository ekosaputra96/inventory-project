...
@section('title', 'Request Pembelian Detail')
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Detail Memo <b>{{$requestbeli->no_request}}</b></font>
    </span>
@include('sweet::alert')
<body onLoad="load()">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            {{ Form::text('no_request',$requestbeli->no_request, ['class'=> 'form-control','readonly','id'=>'norequest']) }}
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
                            {{ Form::label('no_memo', 'No Memo:') }}
                            {{ Form::select('no_memo',$memo->sort(),null,
                ...
                <div class="row">   
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            {{ Form::text('no_memo',$memo, ['class'=> 'form-control','readonly','id'=>'Penerimaan']) }}
                        </div>
                    </div>
...
@push('js')
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({      
            ...
            "bPaginate": false,
            "scrollY": 220,
            ajax:link+'/gui_inventory_laravel/admin/requestpembeliandetail/getDatabyID?id='+no_request,
            data:{'no_request':no_request},
            columns: [
                { data: 'no_request', name: 'no_request', visible:false },
        ...
        $('#data3-table').DataTable({      
            ...
            "bPaginate": false,
            "scrollY": 220,
            ajax:link+'/gui_inventory_laravel/admin/requestpembeliandetail/getDatabyID2?id='+no_request,
            data:{'no_request':no_request},
            columns: [
    ...
    <script>
        ...
        $('#ADD_DETAIL').submit(function (e) {
            ...
            $.ajax({
                    url:'{!! route('requestpembeliandetail.store') !!}',
                    type:'POST',
                    data:formData,

...
@section('title', 'Retur Pemakaian Detail')
...
@section('content')
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Detail Retur Pemakaian <b>{{$returpembelian->no_retur_pemakaian}}</b></font>
    </span>
@include('sweet::alert')
<body onLoad="load()">
            ...
            {{ Form::hidden('Link',request()->getSchemeAndHttpHost(), ['class'=> 'form-control','readonly','id'=>'Link1']) }}
                <div class="col-md-2">
                    <div class="form-group1">
                        ...
                        {{ Form::text('no_retur_pemakaian',$returpembelian->no_retur_pemakaian, ['class'=> 'form-control','readonly','id'=>'noretur']) }}
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group2">
                        {{ Form::label('Nomos', 'No Pemakaian:') }}
                        {{ Form::text('no_pemakaian',$returpembelian->no_pemakaian, ['class'=> 'form-control','readonly','id'=>'noterima']) }}
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group3">
                        {{ Form::label('kode_produk', 'Produk:') }}
                        {{ Form::select('kode_produk',$Produk->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','required','id'=>'Produk1','onchange'=>'getinfo();']) }}
                ...
                <div class="col-md-2">
                    <div class="form-group8">
                        {{ Form::label('qty_terima', 'QTY Pemakaian:') }}
                        {{ Form::text('qty_pakai', null, ['class'=> 'form-control','required'=>'required',
                        'id'=>'Qty','readonly']) }}
                    </div>
                </div>
            ...
            <div class="row">   
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        {{ Form::label('Nos', 'No Pemakaian:') }}
                        {{ Form::text('no_pemakaian',$returpembelian->no_pemakaian, ['class'=> 'form-control','readonly','id'=>'Penerimaan']) }}
                    </div>
                </div>
...
@push('js')
    ...
    <script>
        ...
        function getinfo(){
            ...
            $.ajax({
                url:'{!! route('returpemakaiandetail.getinfo') !!}',
                type:'POST',
                data : {
        ...
        $('#ADD_DETAIL').submit(function (e) {
            ...
            $.ajax({
                    url:'{!! route('returpemakaiandetail.store') !!}',
                    type:'POST',
                    data:formData,

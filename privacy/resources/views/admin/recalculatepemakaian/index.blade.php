                                ...
                                <div class="form-group">
                                   ...
                                   <div class="form-group">
                                       <label class="col-sm-3">
                                           ...
                                           {{ Form::selectYear('year', 2021, 2040, null, ['class'=> 'form-control select2','id'=>'namatahun','placeholder'=>'','style'=>'width: 100%'])}}
                                       </label>
                                   </div>
                                </div>
                            </div>
        ...
        $('#button1').click( function () {
            ...
            swal({
                    ...
                    showConfirmButton: false
                        ...
                        $.ajax({
                            url: '{!! route('recalculatepemakaian.change') !!}',
                            type: 'POST',
                            data:formData,

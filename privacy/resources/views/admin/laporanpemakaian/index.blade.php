        ...
        <div class="modal fade" id="button4"  role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                {!! Form::open(['route' => ['laporanpemakaian.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">  
                                            ...
                                            {{Form::select('status', ['SEMUA' => 'SEMUA','POSTED' => 'POSTED','RETUR'=>'RETUR'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'status1','required'=>'required'])}}
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group"> 
                                            {{ Form::label('pilih', 'Format Laporan:') }}              
                                            {{Form::select('jenis_report', ['PDF' => 'PDF', 'excel' => 'Excel'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'report1','required'=>'required', 'onchange'=>"pilih()"])}}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group2">
                                            {{ Form::label('item2', 'Pilih Field (Report Excel):') }}
                                            {{ Form::select('item2[]', ['SEMUA' => 'SEMUA', 'kode_produk' => 'Kode Produk', 'nama_produk' => 'Nama Produk', 'partnumber' => 'Partnumber', 'kode_satuan' => 'Satuan', 'kode_kategori' => 'Kategori', 'harga' => 'Harga', 'subtotal' => 'Subtotal'], null, ['class'=> 'form-control select2','id'=>'item','required'=>'required','style'=>'width: 100%', 'multiple' => 'multiple'])}}
                                        </div>
                                    </div>
                                    <div class="col-sm-6">  

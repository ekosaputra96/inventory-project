...
@section('title', 'Laporan Transfer Out')
        ...
        <div class="modal fade" id="button4"  role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                {!! Form::open(['route' => ['laporantransferout.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]) !!}
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    {{ Form::hidden('status', 'CLOSED', ['class'=> 'form-control','id'=>'status1','readonly']) }}
                                    <!--<div class="col-sm-4">-->
                                    <!--    <div class="form-group">  -->
                                    <!--        {{ Form::label('pilih', 'Status:') }}              -->
                                    <!--        {{Form::select('status', ['POSTED' => 'POSTED'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'status1','required'=>'required'])}}-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    <div class="col-sm-4">  

...
@section('title', 'Assembling Detail')
...
@section('content')
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Detail Assembling <b>{{$assembling->produk->nama_produk}}</b></font>
    </span>
@include('sweet::alert')
<body onLoad="load()">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                {{ Form::label('nomor', 'No Assembling:') }}
                                {{ Form::text('no_ass',$assembling->no_ass, ['class'=> 'form-control','readonly','id'=>'id_dis']) }}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                {{ Form::label('hpp', 'HPP:') }}
                                {{ Form::text('hpp', null, ['class'=>'form-control','required'=>'required','id'=>'hpp','autocomplete'=>'off','readonly']) }}
                            </div>
                        </div>
                    </div> 
                    <span class="pull-right">
            ...
            <div class="editform">
                ...
                {!! Form::open(['id'=>'UPDATE_DETAIL']) !!}
                 <center><kbd>EDIT FORM</kbd></center><br>
                    <div class="row">   
                            {{ Form::hidden('no_ass',$assembling->no_ass, ['class'=> 'form-control','readonly','id'=>'id_dis1']) }}
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    {{ Form::label('qty_stock', 'Ending Stock:') }}
                                    {{ Form::text('qty_stock', null, ['class'=> 'form-control','readonly','id'=>'Stock_e']) }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    {{ Form::label('qty', 'Qty:') }}
                                    {{ Form::text('qty', null, ['class'=> 'form-control','id'=>'QTY_e','required','autocomplete'=>'off','onkeyup'=>'cek_qty2();']) }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    {{ Form::label('hpp', 'HPP:') }}
                                    {{ Form::text('hpp',null, ['class'=> 'form-control','id'=>'Harga_e','required','readonly']) }}
                                </div>
                            </div>
                        </div> 
                            <div class="row-md-2">
...
@push('js')
    ...
    <script>
        ...
        var link = $('#Link1').val();
            ...
            processing: true,
            serverSide: true,
            ajax:link+'/gui_inventory_laravel_trial/admin/assemblingdetail/getDatabyID?id='+id,
            data:{'id':id},
    
            columns: [
                { data: 'id_detail', name: 'id_detail', visible: false },
                { data: 'no_ass', name: 'no_ass', visible: false },
  ...
  <script>
        ...
        function cek_qty2(){
            ...
            var qty = $('#QTY_e').val();
             ...
             $.ajax({
                url:'{!! route('assemblingdetail.qtyproduk2') !!}',
                type:'POST',
                data : {
        ...
        function getharga(){
            ...
            $.ajax({
                url:'{!! route('assemblingdetail.getharga') !!}',
                type:'POST',
                data : {
                    'id': kode_produk,
                    'part': partnumber,
        ...
        function editpart(){
            ...
            $.ajax({
                url: "{!! route('assemblingdetail.selectpart') !!}",
                method: 'POST',
        ...
        $('#ADD_DETAIL').submit(function (e) {
            ...
            $.ajax({
                    url:'{!! route('assemblingdetail.store') !!}',
                    type:'POST',
                    data:formData,
                    success:function(data) {
        ...
        $('#UPDATE_DETAIL').submit(function (e) {
            ...
            // Check if empty of not
                $.ajax({
                    url:'{!! route('assemblingdetail.updateajax') !!}',
                    type:'POST',
                    data:formData,
                    success:function(data) {

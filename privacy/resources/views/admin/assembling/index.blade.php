            ...
            {!! Form::open(['id'=>'ADD']) !!}
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    {{ Form::label('kode_produk', 'Produk Jadi:') }}
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('qty_assembling', 'Qty Assembling:') }}
                                    {{ Form::text('qty_assembling', 1, ['class'=>'form-control','required'=>'required','id'=>'QTY','readonly']) }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('hpp', 'HPP:') }}
                                    {{ Form::text('hpp',null, ['class'=> 'form-control','id'=>'Harga','required']) }}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    {{ Form::label('jas', 'Jasa:') }}
                                    {{ Form::text('nama_jasa', null, ['class'=>'form-control','id'=>'Jasa1','placeholder'=>'Nama Jasa']) }}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('jas', 'Biaya Jasa:') }}
                                    {{ Form::text('biaya_jasa', 0, ['class'=>'form-control','id'=>'Biaya1']) }}
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
              ...
              <div class="modal-content">
                ...
                @include('errors.validation')
                    {!! Form::open(['id'=>'EDIT']) !!}
                        <div class="modal-body">
                            <div class="row">
                                {{ Form::hidden('no_ass', null, ['class'=> 'form-control','id'=>'id1']) }}
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Form::label('qty_assembling', 'Qty Assembling:') }}
                                        {{ Form::text('qty_assembling', null, ['class'=>'form-control','required'=>'required','id'=>'QTY1','autocomplete'=>'off']) }}
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Form::label('hpp', 'HPP:') }}
                                        {{ Form::text('hpp',null, ['class'=> 'form-control','id'=>'Harga1','required']) }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('jas', 'Jasa:') }}
                                        {{ Form::text('nama_jasa', null, ['class'=>'form-control','id'=>'Jasa2','placeholder'=>'Nama Jasa']) }}
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Form::label('jas', 'Biaya Jasa:') }}
                                        {{ Form::text('biaya_jasa', null, ['class'=>'form-control','id'=>'Biaya2']) }}
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
...
@push('js')
    ...
    <script>
        ...
        function editpart(){
            ...
            $.ajax({
                url: "{!! route('assembling.selectpart') !!}",
                method: 'POST',
        ...
        $(document).ready(function() {
           ...
           $('#button1').click( function () {
            ...
            $('#button2').click( function () {
                ...
                swal({
                    ...
                    reverseButtons: !0
                        ...
                        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                        $.ajax({
                            url: '{!! route('assembling.unposting') !!}',
                            type: 'POST',
                            data : {
                                'id': id
                            },
            ...
            $('#detailjurnal2').click( function () {
                ...
                var no_journal = data['no_journal'];
                $.ajax({
                    url: '{!! route('assembling.getDatajurnal2') !!}',
                    type: 'GET',
                    data : {
                        'id': no_journal,
                    },
            ...
            function cekjurnal2(){
                ...
                $.ajax({
                    url:'{!! route('assembling.cekjurnal2') !!}',
                    type:'POST',
                    data : {
            ...
            $('#button3').click( function () {
                ...
                var id = data['no_ass'];
                $.ajax({
                    url: '{!! route('assembling.showdetail') !!}',
                    type: 'POST',
                    data : {
                        'id': id
                    },
            ...
            $('#editassembling').click( function () {
                ...
                var id = data['no_ass'];
                $.ajax({
                    url: '{!! route('assembling.edit_assembling') !!}',
                    type: 'POST',
                    data : {
                        'id': id
                    },
            ...
            $('#hapusassembling').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '{!! route('assembling.hapus_assembling') !!}',
                            type: 'POST',
                            data : {
                                'id': id
                            },
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'{!! route('assembling.updateAjax') !!}',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        $('#editform').modal('hide');
